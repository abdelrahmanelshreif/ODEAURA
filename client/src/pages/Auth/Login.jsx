...
// ------------------------------------------------------------------------------
// Refined After Going to URL PARAMS
// ------------------------------------------------------------------------------
// import { useEffect, useState } from 'react';
// import {
//   TextInput,
...
//       } catch (err) {
//         console.error(err);
//         setLoginLoading(false); // Stop showing the loader
//       }
//     };
//     checkUser();
//   }, [auth, navigate, fromUrl]);

//   // Handling form submission and login logic
//   const form = useForm({
//     initialValues: {
//       email: '',
//       password: '',
...
//       // Set the auth token and navigate to the desired route
//       setAuth({
//         ...auth,
//         token: res.user,
//       });
//       navigate(fromUrl); // Navigate directly to the original intended page
//     } catch (err) {
//       notifications.show({
//         color: 'red',
//         title: 'Invalid credentials',
